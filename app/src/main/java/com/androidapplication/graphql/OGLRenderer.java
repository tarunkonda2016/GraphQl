...
import com.androidapplication.graphql.glkit.ShaderProgram;
import com.androidapplication.graphql.glkit.ShaderUtils;
import com.androidapplication.graphql.glkit.TextureUtils;
...
public class OGLRenderer implements GLSurfaceView.Renderer {
    ...
    private static final float ONE_SEC = 500.0f; // 1 second
